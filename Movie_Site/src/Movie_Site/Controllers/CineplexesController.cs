...
namespace Movie_Site.Controllers
{
    public class CineplexesController : Controller
    {
        ...
        public CineplexesController(Movie_SiteContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("CineplexId,Cdescription,ImageUrl,Location")] Cineplex cineplex)
        {
